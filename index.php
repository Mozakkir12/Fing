...
<div class="modal fade" id="addUserModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form"
                  ...
                  method="post" id="form" enctype="multipart/form-data" style="display: none;">
                <!-- মূল ফর্ম কন্টেন্ট -->
                <div class="modal-body">
                    <!-- মূল ফর্মের ইনপুট ফিল্ডস, যা অকার্যকর থাকবে -->
                </div>
            </form>

            <!-- insert_person.php ফর্ম লোড করার জন্য iframe -->
            <div class="modal-body">
                <iframe src="user_register.php" frameborder="0" style="width: 100%; height: 400px;"></iframe>
            </div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<h1>Online Fingerprint Time Attendance Software</h1>
		...
		<button class="btn btn-primary" id="logInfo_emp_modal_btn">Download Log</button>
	
	<button class="btn btn-primary" id="redirectButton">Daily Report</button>

    <script>
        document.getElementById('redirectButton').addEventListener('click', function() {
            window.location.href = 'report/attendance_report.php'; // এটি আপনাকে নতুন পেজে রিডাইরেক্ট করবে
        });
    </script>
			<button class="btn btn-primary" id="redirectButton1">Monthly Report</button>
			<script>
        document.getElementById('redirectButton1').addEventListener('click', function() {
            window.location.href = 'report/monthly_report.php'; // এটি আপনাকে নতুন পেজে রিডাইরেক্ট করবে
        });
    </script>
    
    
    	<button class="btn btn-primary" id="redirectButton4"> Add Department</button>
			<script>
        document.getElementById('redirectButton4').addEventListener('click', function() {
            window.location.href = 'department_form.php'; // এটি আপনাকে নতুন পেজে রিডাইরেক্ট করবে
        });
    </script>
    
    
    
    	<button class="btn btn-primary" id="redirectButton3">Add Branch</button>
			<script>
        document.getElementById('redirectButton3').addEventListener('click', function() {
            window.location.href = 'branch_name.php'; // এটি আপনাকে নতুন পেজে রিডাইরেক্ট করবে
        });
    </script>
    
    
    	<button class="btn btn-primary" id="redirectButton5">Branch Registration</button>
			<script>
        document.getElementById('redirectButton5').addEventListener('click', function() {
            window.location.href = 'branch_register.php'; // এটি আপনাকে নতুন পেজে রিডাইরেক্ট করবে
        });
    </script>
		...
		<button class="btn btn-primary" id="addUser_modal_btn">Add user</button>
			<button class="btn btn-primary" id="redirectButton7">Manage User</button>

    <script>
        document.getElementById('redirectButton7').addEventListener('click', function() {
            window.location.href = 'manage_person.php'; // এটি আপনাকে নতুন পেজে রিডাইরেক্ট করবে
        });
    </script>
		...
		<button class="btn btn-primary" id="cleanAdmin_modal_btn">cleanAdmin</button>
				<button class="btn btn-primary" id="redirectButton8">Ip Master</button>

    <script>
        document.getElementById('redirectButton8').addEventListener('click', function() {
            window.location.href = 'ip_master.php'; // এটি আপনাকে নতুন পেজে রিডাইরেক্ট করবে
        });
    </script>
    ...
    <script>
        ...
        $('#startButton').click(function() {
            interval = setInterval(function() {
                $.ajax({
                    url: 'ws.php',  // PHP ফাইল যা গোপনে চলবে
                    success: function(response) {
                        $('#status').text('Running...');
                    }
                });
            }, 1000); // প্রতি 1 সেকেন্ডে একবার করে রান হবে
        });
